...
import {
  ...
  MapPin, Mail, Phone, Clock, UserCheck, HeartHandshake,
  Sparkles, ShieldCheck, Quote,
} from 'lucide-react'
...
const DAILY_WORKFLOWS = [
  {
    ...
    icon: ShieldCheck,
    tagline: 'Real-time oversight and effortless campus governance from dawn to dusk.',
    steps: [
      {
  ...
  },
  {
    ...
    icon: UserCheck,
    tagline: 'Spend less time on administrative paperwork and more time inspiring students.',
    steps: [
      {
  ...
  },
  {
    ...
    role: 'Students',
    icon: GraduationCap,
    tagline: 'A personalized academic companion to learn, organize, and achieve excellence.',
    steps: [
      {
  ...
  },
  {
    ...
    icon: HeartHandshake,
    tagline: 'Stay securely connected with your child’s educational journey every single day.',
    steps: [
      {
...
const IMPACT_METRICS = [
  { value: '2+ Hours', label: 'Saved Daily per Teacher', desc: 'Zero manual attendance registers or repetitive paper record keeping.' },
  { value: '100%', label: 'Parent Engagement', desc: 'Real-time updates on attendance, tests, and campus announcements.' },
  { value: '95%', label: 'Paperless Administration', desc: 'Digital admissions, hall tickets, fee receipts, and grade reports.' },
  { value: '99.9%', label: 'Cloud Uptime & Security', desc: 'Bank-grade enterprise data safety built on modern infrastructure.' }
]
  ...
  return (
    <>
      ...
      <section className="bg-[var(--cream)] pt-2 pb-12">
        ...
        <div id="features" className="text-center max-w-3xl mx-auto px-6 mb-8 mt-2 scroll-mt-24 md:scroll-mt-24">
      ...
      <section id="campus" className="bg-[var(--cream)] py-12 scroll-mt-24 md:scroll-mt-28">
        <div className="mx-auto w-full max-w-[1240px] px-6 lg:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-[var(--text-secondary)] font-medium text-[15px] leading-relaxed">
              Explore how EduWeConnect seamlessly synchronizes morning roll-calls, afternoon assessments, fee dues, and evening announcements across every role on campus.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 mb-10">
            {DAILY_WORKFLOWS.map((w, idx) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-4 h-4 ${isActive ? 'text-[var(--gold)]' : 'text-[var(--navy)]/60'}`} />
                  {w.role}
                </button>
              )
            })}
          ...
          <div className="relative overflow-hidden flex flex-col md:flex-row items-center justify-between p-8 md:p-10 bg-gradient-to-r from-[var(--deep-navy)] to-[var(--navy)] rounded-2xl shadow-md text-white gap-6">
            <div className="max-w-2xl text-center md:text-left">
              ...
              <p className="text-[13px] text-[var(--light-gold)] font-semibold">
                — Mahatma Gandhi · Shared across EduWeConnect daily morning broadcasts
              </p>
            </div>
      ...
      <section id="contact" className="bg-[var(--cream)] pb-16 pt-2 scroll-mt-24 md:scroll-mt-28">
        <div className="mx-auto w-full max-w-[1200px] px-6 lg:px-12">
          ...
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="text-[var(--text-secondary)] font-medium text-[14.5px] leading-relaxed">
              Connect directly with our institutional support and implementation team.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-[var(--warm-white)] rounded-xl border border-[var(--border)] shadow-sm hover:shadow-md transition-all">
              <div className="w-12 h-12 rounded-full bg-[var(--cream)] flex items-center justify-center text-[var(--navy)] mb-4 border border-[var(--border)]">
                <MapPin className="w-5 h-5 text-[var(--gold)]" strokeWidth={1.75} />
              </div>
              <h3 className="font-bold text-[var(--navy)] text-[14.5px] mb-1.5">Registered Office</h3>
              <p className="text-[13px] text-[var(--text-secondary)] leading-relaxed">
                Sutta Pitaka Tech Pvt. Ltd.<br />
            ...
            <div className="flex flex-col items-center text-center p-6 bg-[var(--warm-white)] rounded-xl border border-[var(--border)] shadow-sm hover:shadow-md transition-all">
              <div className="w-12 h-12 rounded-full bg-[var(--cream)] flex items-center justify-center text-[var(--navy)] mb-4 border border-[var(--border)]">
                <Mail className="w-5 h-5 text-[var(--gold)]" strokeWidth={1.75} />
              </div>
              <h3 className="font-bold text-[var(--navy)] text-[14.5px] mb-1.5">Email Support</h3>
              <a href="mailto:contact@suttapitaka.tech" className="text-[13px] text-[var(--navy)] font-semibold hover:text-[var(--gold)] transition-colors">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-[var(--warm-white)] rounded-xl border border-[var(--border)] shadow-sm hover:shadow-md transition-all">
              <div className="w-12 h-12 rounded-full bg-[var(--cream)] flex items-center justify-center text-[var(--navy)] mb-4 border border-[var(--border)]">
                <Phone className="w-5 h-5 text-[var(--gold)]" strokeWidth={1.75} />
              </div>
              <h3 className="font-bold text-[var(--navy)] text-[14.5px] mb-1.5">Helpline</h3>
              <a href="tel:+918001234567" className="text-[13px] text-[var(--navy)] font-semibold hover:text-[var(--gold)] transition-colors">
                +91 (080) 4123-4567
              </a>
              <p className="text-[12px] text-[var(--text-muted)] mt-1">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-[var(--warm-white)] rounded-xl border border-[var(--border)] shadow-sm hover:shadow-md transition-all">
              <div className="w-12 h-12 rounded-full bg-[var(--cream)] flex items-center justify-center text-[var(--navy)] mb-4 border border-[var(--border)]">
                <Clock className="w-5 h-5 text-[var(--gold)]" strokeWidth={1.75} />
              </div>
              <h3 className="font-bold text-[var(--navy)] text-[14.5px] mb-1.5">Platform Support</h3>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between p-6 sm:p-8 bg-gradient-to-r from-[var(--warm-white)] via-[var(--warm-white)] to-[var(--beige)] rounded-2xl border border-[var(--border)] shadow-sm gap-6">
            <div className="text-center sm:text-left">
              ...
              <p className="text-[13px] md:text-[13.5px] text-[var(--text-secondary)] font-medium">
                Reach out to Sutta Pitaka Tech team for institutional integration and customized onboarding.
              </p>
            </div>

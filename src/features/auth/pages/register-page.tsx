...
export default function RegisterPage() {
  return (
    <div className="relative flex flex-col min-h-screen w-full overflow-hidden bg-[var(--cream)]">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full max-w-[1100px]">
          ...
          <div className="w-full max-w-[480px]">
            ...
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <h1 className="text-2xl font-serif font-bold text-[var(--navy)] mb-1">Create Your Account</h1>
      ...
      {/* Bottom Footer Bar */}
      <div className="relative z-20 w-full bg-[var(--deep-navy)] py-4 px-6 md:px-12 mt-auto">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-[var(--footer-text)]/70 text-[11.5px] font-medium">

          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5"><ShieldCheck className="w-3.5 h-3.5 text-[var(--gold)]" /> Secure</span>
            <span className="w-px h-3 bg-[var(--footer-text)]/20" />

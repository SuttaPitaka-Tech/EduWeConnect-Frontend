      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <OnboardingFileUpload
            ...
            file={regCertFile}
            onFileSelect={(file) =>
              setValue("regCertFile", file, { shouldValidate: true })
            }
            onPreview={onPreviewDoc}
      ...
      <div className="space-y-3 pt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                setValue("orgHeadMobile", val, {
                  shouldValidate: !!errors.orgHeadMobile,
                  shouldDirty: true,
                });
              }}
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                setValue("orgHeadAadharNumber", val, {
                  shouldValidate: !!errors.orgHeadAadharNumber,
                  shouldDirty: true,
                });
              }}
          ...
          <OnboardingFileUpload
            ...
            onFileSelect={(file) =>
              setValue("orgHeadAadharFile", file, { shouldValidate: true })
            }
            onPreview={onPreviewDoc}
